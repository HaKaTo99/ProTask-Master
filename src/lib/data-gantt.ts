...
export const tasks: Task[] = [
  // EPS
  { id: 'eps-amdal', title: 'Proyek AMDAL Pembangunan Pabrik', description: 'Studi Analisis Mengenai Dampak Lingkungan untuk rencana pembangunan pabrik.', status: 'In Progress', priority: 'Urgent', startDate: '2025-07-01T00:00:00.000Z', endDate: '2025-12-20T00:00:00.000Z', dependencies: [], type: 'EPS', progress: 10 },

  // WBS 1: Persiapan dan Kerangka Acuan
  { id: 'wbs-1', parentId: 'eps-amdal', title: '1.0 Tahap Persiapan & Penyusunan Kerangka Acuan (KA)', description: 'Fase awal meliputi persiapan administrasi, tim, dan penyusunan dokumen KA.', status: 'Done', priority: 'High', startDate: '2025-07-01T00:00:00.000Z', endDate: '2025-07-31T00:00:00.000Z', dependencies: [], type: 'WBS', progress: 100 },
  { id: 'act-1.1', parentId: 'wbs-1', title: '1.1 Kick-off Meeting dan Pembentukan Tim', description: 'Rapat awal dengan semua pemangku kepentingan dan pembentukan tim studi.', status: 'Done', priority: 'High', assigneeId: 'user-3', startDate: '2025-07-01T09:00:00.000Z', endDate: '2025-07-03T17:00:00.000Z', dependencies: [], type: 'Activity', progress: 100 },
  { id: 'act-1.2', parentId: 'wbs-1', title: '1.2 Pengumpulan Data Sekunder & Studi Pustaka', description: 'Mengumpulkan data awal, peta, dan regulasi yang relevan.', status: 'Done', priority: 'Medium', assigneeId: 'user-2', startDate: '2025-07-04T09:00:00.000Z', endDate: '2025-07-11T17:00:00.000Z', dependencies: [{ id: 'act-1.1', type: 'Finish-to-Start', lag: 0 }], type: 'Activity', progress: 100 },
  { id: 'act-1.3', parentId: 'wbs-1', title: '1.3 Penyusunan Draft Kerangka Acuan (KA)', description: 'Menyusun dokumen Kerangka Acuan untuk lingkup studi AMDAL.', status: 'Done', priority: 'High', assigneeId: 'user-5', startDate: '2025-07-14T09:00:00.000Z', endDate: '2025-07-25T17:00:00.000Z', dependencies: [{ id: 'act-1.2', type: 'Finish-to-Start', lag: 0 }], type: 'Activity', progress: 100 },
  { id: 'milestone-1', parentId: 'wbs-1', title: 'Persetujuan Kerangka Acuan (KA)', description: 'Mendapatkan persetujuan resmi atas dokumen KA dari komisi penilai.', status: 'Done', priority: 'Urgent', startDate: '2025-07-31T17:00:00.000Z', endDate: '2025-07-31T17:00:00.000Z', dependencies: [{ id: 'act-1.3', type: 'Finish-to-Start', lag: 0 }], type: 'Activity', progress: 100 },

  // WBS 2: Pengumpulan Data Primer
  { id: 'wbs-2', parentId: 'eps-amdal', title: '2.0 Tahap Pengumpulan Data Primer', description: 'Survei dan pengambilan sampel di lokasi proyek.', status: 'In Progress', priority: 'High', startDate: '2025-08-01T00:00:00.000Z', endDate: '2025-08-29T00:00:00.000Z', dependencies: [{ id: 'milestone-1', type: 'Finish-to-Start', lag: 0 }], type: 'WBS', progress: 50 },
  { id: 'act-2.1', parentId: 'wbs-2', title: '2.1 Survei Komponen Geofisika-Kimia', description: 'Pengambilan sampel air, udara, dan tanah.', status: 'In Progress', priority: 'High', assigneeId: 'user-4', startDate: '2025-08-01T09:00:00.000Z', endDate: '2025-08-15T17:00:00.000Z', dependencies: [{ id: 'milestone-1', type: 'Finish-to-Start', lag: 0 }], type: 'Activity', progress: 75 },
  { id: 'act-2.2', parentId: 'wbs-2', title: '2.2 Survei Komponen Biologi', description: 'Inventarisasi flora dan fauna di sekitar lokasi proyek.', status: 'In Progress', priority: 'High', assigneeId: 'user-1', startDate: '2025-08-04T09:00:00.000Z', endDate: '2025-08-18T17:00:00.000Z', dependencies: [{ id: 'milestone-1', type: 'Finish-to-Start', lag: 0 }], type: 'Activity', progress: 60 },
  ...
  { id: 'wbs-4', parentId: 'eps-amdal', title: '4.0 Penyusunan Laporan & Finalisasi', description: 'Menyusun dokumen ANDAL, RKL, dan RPL serta asistensi.', status: 'To Do', priority: 'Urgent', startDate: '2025-10-20T00:00:00.000Z', endDate: '2025-12-20T00:00:00.000Z', dependencies: [{ id: 'act-3.3', type: 'Finish-to-Start', lag: 0 }], type: 'WBS', progress: 0 },
  { id: 'act-4.1', parentId: 'wbs-4', title: '4.1 Penyusunan Draft Dokumen ANDAL', description: 'Menyusun laporan Analisis Dampak Lingkungan.', status: 'To Do', priority: 'High', assigneeId: 'user-5', startDate: '2025-10-20T09:00:00.000Z', endDate: '2025-11-14T17:00:00.000Z', dependencies: [{ id: 'act-3.3', type: 'Finish-to-Start', lag: 0 }], type: 'Activity', progress: 0 },
  ...
  { id: 'milestone-2', parentId: 'wbs-4', title: 'Penyerahan Laporan Final', description: 'Penyerahan dokumen final ANDAL dan RKL-RPL yang telah direvisi.', status: 'To Do', priority: 'Urgent', startDate: '2025-12-19T17:00:00.000Z', endDate: '2025-12-19T17:00:00.000Z', dependencies: [{ id: 'act-4.3', type: 'Finish-to-Start', lag: 0 }], type: 'Activity', progress: 0 },
];
